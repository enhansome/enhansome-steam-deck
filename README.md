...
Please follow [our contribution guidelines](https://github.com/airscripts/awesome-steam-deck/blob/main/CONTRIBUTING.md) ⭐ 752 | 🐛 3 | 📅 2026-07-09.
...
* [Distrobox](https://github.com/89luca89/distrobox) ⭐ 12,962 | 🐛 149 | 🌐 Go | 📅 2026-09-02 - Use any Linux distribution inside your terminal.
...
* [Steam ROM Manager](https://github.com/SteamGridDB/steam-rom-manager) ⭐ 2,558 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-08 - An app for managing ROMs in Steam.
* [Protontricks](https://github.com/Matoking/protontricks) ⭐ 2,302 | 🐛 90 | 🌐 Python | 📅 2026-08-18 - Configure Proton prefixes for Steam games.
* [BoilR](https://github.com/PhilipK/BoilR) ⭐ 1,877 | 🐛 111 | 🌐 Rust | 📅 2026-04-23 - Synchronize non-Steam games with your Steam library.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,770 | 🐛 96 | 🌐 JavaScript | 📅 2026-08-31 - Manage Flatpak permissions with a GUI.
* [GOverlay](https://github.com/benjamimgois/goverlay) ⭐ 1,477 | 🐛 82 | 🌐 Pascal | 📅 2026-09-08 - Graphical UI for MangoHud configuration.
* [Clover](https://github.com/ryanrudolfoba/SteamDeck-Clover-dualboot) ⭐ 760 | 🐛 8 | 🌐 Shell | 📅 2026-09-08 - Graphical boot manager for the Steam Deck.
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,009 | 🐛 333 | 🌐 C | 📅 2026-09-08 - Vulkan/OpenGL performance overlay (FPS, temps, CPU/GPU usage).
* [Gamescope](https://github.com/ValveSoftware/gamescope) ⭐ 5,061 | 🐛 950 | 🌐 C++ | 📅 2026-09-07 - Micro-compositor for resolution scaling, frame limiting, and latency improvements.
...
* [shadPS4](https://github.com/shadps4-emu/shadPS4) ⭐ 32,761 | 🐛 216 | 🌐 C++ | 📅 2026-09-07 - PS4 Emulator.
* [RPCS3](https://github.com/RPCS3/rpcs3) ⭐ 19,689 | 🐛 1,076 | 🌐 C++ | 📅 2026-09-07 - PS3 Emulator.
* [PCSX2](https://github.com/PCSX2/pcsx2) ⭐ 15,506 | 🐛 812 | 🌐 C++ | 📅 2026-09-07 - PS2 Emulator.
* [Dolphin](https://github.com/dolphin-emu/dolphin) ⭐ 15,497 | 🐛 467 | 🌐 C++ | 📅 2026-09-06 - Gamecube/Wii Emulator.
* [PPSSPP](https://github.com/hrydgard/ppsspp) ⭐ 14,405 | 🐛 1,365 | 🌐 C++ | 📅 2026-09-08 - PSP Emulator.
* [RetroArch](https://github.com/libretro/RetroArch) ⭐ 13,904 | 🐛 3,010 | 🌐 C | 📅 2026-09-08 - Frontend for emulators, game engines and media players.
* [DuckStation](https://github.com/stenzek/duckstation) ⭐ 10,647 | 🐛 76 | 🌐 C++ | 📅 2026-09-08 - Fast and accurate PlayStation 1 emulator.
* [MAME](https://github.com/mamedev/mame) ⭐ 10,462 | 🐛 890 | 🌐 C++ | 📅 2026-09-08 - Arcade machine emulator.
* [Cemu](https://github.com/cemu-project/Cemu) ⭐ 9,801 | 🐛 403 | 🌐 C++ | 📅 2026-09-07 - Wii U emulator with excellent compatibility.
* [Vita3K](https://github.com/Vita3K/Vita3K) ⭐ 5,693 | 🐛 205 | 🌐 C++ | 📅 2026-09-08 - PS Vita Emulator.
* [melonDS](https://github.com/melonDS-emu/melonDS) ⭐ 4,993 | 🐛 1,051 | 🌐 C++ | 📅 2026-08-23 - Nintendo DS emulator with local multiplayer support.
* [xemu](https://github.com/xemu-project/xemu) ⭐ 4,094 | 🐛 964 | 🌐 C | 📅 2026-09-08 - Xbox Emulator.
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,625 | 🐛 92 | 🌐 C++ | 📅 2026-08-13 - Nintendo DS Emulator.
* [EmuDeck](https://github.com/dragoonDorise/EmuDeck) ⭐ 3,496 | 🐛 90 | 🌐 Shell | 📅 2026-09-08 - Emulator configurator.
* [Flycast](https://github.com/flyinghead/flycast) ⭐ 2,520 | 🐛 298 | 🌐 C++ | 📅 2026-09-08 - Sega Dreamcast/Naomi emulator.
* [bsnes](https://github.com/bsnes-emu/bsnes) ⭐ 1,983 | 🐛 153 | 🌐 C++ | 📅 2026-05-23 - SNES Emulator.
* [RetroDECK](https://github.com/XargonWan/RetroDECK) ⭐ 1,258 | 🐛 300 | 🌐 Shell | 📅 2026-09-03 - All-in-one sandboxed application to play your retro games.
...
* [Prism Launcher](https://github.com/PrismLauncher/PrismLauncher) ⭐ 10,340 | 🐛 773 | 🌐 C++ | 📅 2026-09-07 - Minecraft launcher with mod support.
* [Bottles](https://github.com/bottlesdevs/Bottles) ⭐ 8,791 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Run Windows software and games under Linux.
* [Legendary](https://github.com/derrod/legendary) ⭐ 5,289 | 🐛 111 | 🌐 Python | 📅 2026-09-05 - CLI launcher for Epic Games Store.
* [NonSteamLaunchers](https://github.com/moraroy/NonSteamLaunchers-On-Steam-Deck) ⭐ 4,359 | 🐛 158 | 🌐 Python | 📅 2026-09-07 - Automatic installation of the most popular launchers.
* [Minigalaxy](https://github.com/sharkwouter/minigalaxy) ⭐ 1,329 | 🐛 98 | 🌐 Python | 📅 2026-09-07 - Lightweight GOG client for Linux.
...
* [LocalSend](https://github.com/localsend/localsend) ⭐ 90,345 | 🐛 1,110 | 🌐 Dart | 📅 2026-08-31 - Open source app to share files between devices over your local network.
* [Sunshine](https://github.com/LizardByte/Sunshine) ⭐ 41,008 | 🐛 151 | 🌐 C++ | 📅 2026-09-08 - Self-hosted game stream host (pairs with Moonlight).
* [Moonlight](https://github.com/moonlight-stream/moonlight-qt) ⭐ 18,561 | 🐛 559 | 🌐 C++ | 📅 2026-09-07 - Stream games from PC with NVIDIA GPU.
* [KDE Connect](https://github.com/KDE/kdeconnect-kde) ⭐ 3,981 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Multi-platform app that allows your devices to communicate.
* [Greenlight](https://github.com/unknownskl/greenlight) ⭐ 2,856 | 🐛 232 | 🌐 TypeScript | 📅 2026-09-07 - An open source client for streaming Xbox Cloud and Xbox Home.
...
* [Syncthing](https://github.com/syncthing/syncthing) ⭐ 88,389 | 🐛 382 | 🌐 Go | 📅 2026-09-08 - Open source continuous file synchronization.
...
* [CompSize](https://github.com/kilobyte/compsize) ⭐ 413 | 🐛 22 | 🌐 C | 📅 2023-12-25 - Check btrfs compression ratios on Steam Deck.
...
* [Ludusavi](https://github.com/mtkennerly/ludusavi) ⭐ 6,248 | 🐛 61 | 🌐 Rust | 📅 2026-09-06 - Backup tool for PC game saves.
...
* [Decky Loader](https://github.com/SteamDeckHomebrew/decky-loader) ⭐ 7,243 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-02 - Plugin launcher.
