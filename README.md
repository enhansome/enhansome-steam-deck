...
* [Distrobox](https://github.com/89luca89/distrobox) ⭐ 12,995 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Use any Linux distribution inside your terminal.
...
* [Steam ROM Manager](https://github.com/SteamGridDB/steam-rom-manager) ⭐ 2,568 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-22 - An app for managing ROMs in Steam.
* [Protontricks](https://github.com/Matoking/protontricks) ⭐ 2,311 | 🐛 91 | 🌐 Python | 📅 2026-08-18 - Configure Proton prefixes for Steam games.
* [BoilR](https://github.com/PhilipK/BoilR) ⭐ 1,883 | 🐛 116 | 🌐 Rust | 📅 2026-04-23 - Synchronize non-Steam games with your Steam library.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,784 | 🐛 97 | 🌐 JavaScript | 📅 2026-08-31 - Manage Flatpak permissions with a GUI.
* [GOverlay](https://github.com/benjamimgois/goverlay) ⭐ 1,495 | 🐛 85 | 🌐 Pascal | 📅 2026-09-22 - Graphical UI for MangoHud configuration.
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,057 | 🐛 338 | 🌐 C | 📅 2026-09-16 - Vulkan/OpenGL performance overlay (FPS, temps, CPU/GPU usage).
* [Gamescope](https://github.com/ValveSoftware/gamescope) ⭐ 5,107 | 🐛 970 | 🌐 C++ | 📅 2026-09-22 - Micro-compositor for resolution scaling, frame limiting, and latency improvements.
...
* [shadPS4](https://github.com/shadps4-emu/shadPS4) ⭐ 32,931 | 🐛 237 | 🌐 C++ | 📅 2026-09-21 - PS4 Emulator.
* [RPCS3](https://github.com/RPCS3/rpcs3) ⭐ 19,834 | 🐛 1,087 | 🌐 C++ | 📅 2026-09-22 - PS3 Emulator.
* [PCSX2](https://github.com/PCSX2/pcsx2) ⭐ 15,611 | 🐛 804 | 🌐 C++ | 📅 2026-09-21 - PS2 Emulator.
* [Dolphin](https://github.com/dolphin-emu/dolphin) ⭐ 15,554 | 🐛 484 | 🌐 C++ | 📅 2026-09-21 - Gamecube/Wii Emulator.
* [PPSSPP](https://github.com/hrydgard/ppsspp) ⭐ 14,514 | 🐛 1,321 | 🌐 C++ | 📅 2026-09-22 - PSP Emulator.
* [RetroArch](https://github.com/libretro/RetroArch) ⭐ 14,082 | 🐛 3,003 | 🌐 C | 📅 2026-09-22 - Frontend for emulators, game engines and media players.
* [DuckStation](https://github.com/stenzek/duckstation) ⭐ 10,726 | 🐛 77 | 🌐 C++ | 📅 2026-09-22 - Fast and accurate PlayStation 1 emulator.
* [MAME](https://github.com/mamedev/mame) ⭐ 10,516 | 🐛 895 | 🌐 C++ | 📅 2026-09-22 - Arcade machine emulator.
* [Cemu](https://github.com/cemu-project/Cemu) ⭐ 9,862 | 🐛 402 | 🌐 C++ | 📅 2026-09-21 - Wii U emulator with excellent compatibility.
* [Vita3K](https://github.com/Vita3K/Vita3K) ⭐ 5,745 | 🐛 224 | 🌐 C++ | 📅 2026-09-21 - PS Vita Emulator.
* [melonDS](https://github.com/melonDS-emu/melonDS) ⭐ 5,049 | 🐛 1,063 | 🌐 C++ | 📅 2026-08-23 - Nintendo DS emulator with local multiplayer support.
* [xemu](https://github.com/xemu-project/xemu) ⭐ 4,117 | 🐛 968 | 🌐 C | 📅 2026-09-21 - Xbox Emulator.
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,640 | 🐛 92 | 🌐 C++ | 📅 2026-09-11 - Nintendo DS Emulator.
* [EmuDeck](https://github.com/dragoonDorise/EmuDeck) ⭐ 3,500 | 🐛 82 | 🌐 Shell | 📅 2026-09-22 - Emulator configurator.
* [Flycast](https://github.com/flyinghead/flycast) ⭐ 2,546 | 🐛 302 | 🌐 C++ | 📅 2026-09-22 - Sega Dreamcast/Naomi emulator.
* [bsnes](https://github.com/bsnes-emu/bsnes) ⭐ 1,991 | 🐛 155 | 🌐 C++ | 📅 2026-05-23 - SNES Emulator.
* [RetroDECK](https://github.com/XargonWan/RetroDECK) ⭐ 1,266 | 🐛 303 | 🌐 Shell | 📅 2026-09-20 - All-in-one sandboxed application to play your retro games.
...
* [Prism Launcher](https://github.com/PrismLauncher/PrismLauncher) ⭐ 10,467 | 🐛 768 | 🌐 C++ | 📅 2026-09-22 - Minecraft launcher with mod support.
* [Bottles](https://github.com/bottlesdevs/Bottles) ⭐ 8,855 | 🐛 31 | 🌐 Python | 📅 2026-09-22 - Run Windows software and games under Linux.
* [Legendary](https://github.com/derrod/legendary) ⭐ 5,305 | 🐛 115 | 🌐 Python | 📅 2026-09-08 - CLI launcher for Epic Games Store.
* [NonSteamLaunchers](https://github.com/moraroy/NonSteamLaunchers-On-Steam-Deck) ⭐ 4,373 | 🐛 160 | 🌐 Python | 📅 2026-09-22 - Automatic installation of the most popular launchers.
* [Minigalaxy](https://github.com/sharkwouter/minigalaxy) ⭐ 1,327 | 🐛 98 | 🌐 Python | 📅 2026-09-09 - Lightweight GOG client for Linux.
...
* [LocalSend](https://github.com/localsend/localsend) ⭐ 92,440 | 🐛 1,135 | 🌐 Dart | 📅 2026-09-14 - Open source app to share files between devices over your local network.
* [Sunshine](https://github.com/LizardByte/Sunshine) ⭐ 41,435 | 🐛 162 | 🌐 C++ | 📅 2026-09-22 - Self-hosted game stream host (pairs with Moonlight).
* [Moonlight](https://github.com/moonlight-stream/moonlight-qt) ⭐ 18,725 | 🐛 562 | 🌐 C++ | 📅 2026-09-20 - Stream games from PC with NVIDIA GPU.
* [KDE Connect](https://github.com/KDE/kdeconnect-kde) ⭐ 4,017 | 🐛 0 | 🌐 C++ | 📅 2026-09-22 - Multi-platform app that allows your devices to communicate.
* [Greenlight](https://github.com/unknownskl/greenlight) ⭐ 2,874 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-21 - An open source client for streaming Xbox Cloud and Xbox Home.
...
* [Syncthing](https://github.com/syncthing/syncthing) ⭐ 88,836 | 🐛 383 | 🌐 Go | 📅 2026-09-22 - Open source continuous file synchronization.
...
* [Ludusavi](https://github.com/mtkennerly/ludusavi) ⭐ 6,296 | 🐛 61 | 🌐 Rust | 📅 2026-09-11 - Backup tool for PC game saves.
...
* [Decky Loader](https://github.com/SteamDeckHomebrew/decky-loader) ⭐ 7,282 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-21 - Plugin launcher.
